...
import com.bhavani.muzicplayer.databinding.ActivityPlayerBinding
...
class PlayerActivity : AppCompatActivity(),ServiceConnection,MediaPlayer.OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.favouriteBtnPA.setOnClickListener {
            ...
            if (isFavourite) {
                ...
                isFavourite = true
                binding.favouriteBtnPA.setImageResource(R.drawable.favorites_icon)
    ...
    private fun setLayout(){
        ...
        if (isFavourite) binding.favouriteBtnPA.setImageResource(R.drawable.favorites_icon)
